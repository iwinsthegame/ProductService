...
(
    user_id BIGINT NOT NULL,
    psp DOUBLE NOT NULL,
    CONSTRAINT pk_jt_students PRIMARY KEY (user_id)
);
...
CREATE TABLE some_mode
(
    id   BINARY(16)   NOT NULL,
    name VARCHAR(255) NULL,
    CONSTRAINT pk_somemode PRIMARY KEY (id)
);
...
ALTER TABLE jt_students
    ADD CONSTRAINT FK_JT_STUDENTS_ON_USER FOREIGN KEY (user_id) REFERENCES jt_user (id);
